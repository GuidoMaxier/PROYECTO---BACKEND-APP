...
userserver_bp.route('/<int:film_id>', methods=['GET'])(UserServerController.get)
userserver_bp.route('/', methods=['POST'])(UserServerController.create)
userserver_bp.route('/<int:film_id>', methods=['PUT'])(UserServerController.update)
userserver_bp.route('/<int:film_id>', methods=['DELETE'])(UserServerController.delete)